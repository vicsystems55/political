...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="ie=edge"/>
  <title>Nduka Anyanwu Foundation</title>
  <!-- favicon -->
        ...
        <div class="col-lg-6 col-md-6">
          <div class="top-single-items">
            ...
            <div class="top-single-item">
              ...
              <div class="content">
                <h5 class="title"><a href="https://themeim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="caa3a4aca58aada7aba3a6e4a9a5a7">[email&#160;protected]</a></h5>
              </div>
            </div>
            <div class="top-single-item">
...
<!-- Header section End -->
      ...
      <div class="row">
        <div class="testimonial-carousel">
          <div class="single-testimonial-item wow animate__animated animate__fadeInUp">
            <img src="assets/img/flag-shape.png" class="shape-01" alt="" />
            <div class="icon">
  ...
  <div class="our-party-section-area">
    <div class="party-bg" style="background-image: url(assets/img/leader-01.png)"></div>
    <img src="assets/img/party-shape.png" class="party-shape" alt="" />
    <img src="assets/img/party-shape-02.png" class="party-shape-01" alt="" />
    <div class="party-shape-02"></div>
    <div class="party-shape-03"></div>
      ...
      <div class="news-section-start">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-10">
              <div class="section-title">
                ...
                <h4 class="title wow animate__animated animate__fadeInUp">Donations</h4>

                <p class="description wow animate__ animate__fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    Nduka Anyanwu's foundation demonstrates compassion by directing donations to construct shelters, providing both physical refuge and a sense of security for those in need. Beyond conventional philanthropy, the foundation's strategic donations address homelessness, empowering vulnerable populations and reflecting a commitment to making a meaningful impact on their lives with a focus on dignity and inclusivity.
              </p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-6 col-md-12">
              <div class="news-single-items wow animate__animated animate__fadeInUp">
                <div class="news-bg" style="background-image: url(assets/img/gallery-99.png);">
                  {{-- <span class="even">Event</span> --}}
                  <div class="content">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="news-single-items wow animate__animated animate__fadeInUp">
                  <div class="news-bg" style="background-image: url(assets/img/gallery-999.png);">
                    {{-- <span class="even">Event</span> --}}
                    <div class="content">
                      <a href="news-single"><h4 class="title">Many have given us their trust</h4></a>
                      <div class="author-meta">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="news-single-items wow animate__animated animate__fadeInUp">
                  <div class="news-bg" style="background-image: url(assets/img/gallery-9999.png);">
                    {{-- <span class="even">Event</span> --}}
                    <div class="content">
                      <a href="news-single"><h4 class="title">Many have given us their trust</h4></a>
                      <div class="author-meta">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="news-single-items wow animate__animated animate__fadeInUp">
                  <div class="news-bg" style="background-image: url(assets/img/gallery-88.png);">
                    {{-- <span class="even">Event</span> --}}
                    <div class="content">
                      <a href="news-single"><h4 class="title">Many have given us their trust</h4></a>
                      <div class="author-meta">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="news-single-items wow animate__animated animate__fadeInUp">
                  <div class="news-bg" style="background-image: url(assets/img/gallery-888.png);">
                    {{-- <span class="even">Event</span> --}}
                    <div class="content">
                      <a href="news-single"><h4 class="title">Many have given us their trust</h4></a>
                      <div class="author-meta">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="news-single-items wow animate__animated animate__fadeInUp">
                  <div class="news-bg" style="background-image: url(assets/img/gallery-77.png);">
                    {{-- <span class="even">Event</span> --}}
                    <div class="content">
                      <a href="news-single"><h4 class="title">Many have given us their trust</h4></a>
                      <div class="author-meta">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="news-single-items wow animate__animated animate__fadeInUp">
                  <div class="news-bg" style="background-image: url(assets/img/gallery-55.png);">
                    {{-- <span class="even">Event</span> --}}
                    <div class="content">
                      <a href="news-single"><h4 class="title">Many have given us their trust</h4></a>
                      <div class="author-meta">
  ...
  <div class="campaign-section-area d-none">
    <div class="container">
      ...
      <div class="campaign-single-item">
        <div class="row">
          <div class="col-lg-7">
            <div class="campaign-bg" style="background-image: url(assets/img/audience.png)">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="campaign-single-items-02 wow animate__animated animate__fadeInLeft">
            ...
            <img src="assets/img/setting-shape.png" class="shape" alt="" />
          </div>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row">
        <div class="testimonial-carousel-two">
          <div class="volunteer-single-items">
            <div class="thum">
              <img src="assets/img/volunteer-03.png" alt="" />
            </div>
            <div class="content">
              <div class="author-meta">
          ...
          <div class="volunteer-single-items">
            <div class="thum">
              <img src="assets/img/volunteer-01.png" alt="" />
            </div>
            <div class="content">
              <div class="author-meta">
                <span class="author-name">Pier Goodman</span>
          ...
          <div class="volunteer-single-items">
            <div class="thum">
              <img src="assets/img/volunteer-02.png" alt="" />
            </div>
            <div class="content">
              <div class="author-meta">
                <span class="author-name">Pier Goodman</span>
          ...
          <div class="volunteer-single-items">
            <div class="thum">
              <img src="assets/img/volunteer-04.png" alt="" />
            </div>
            <div class="content">
              <div class="author-meta">
                <span class="author-name">Pier Goodman</span>
          ...
          <div class="volunteer-single-items">
            <div class="thum">
              <img src="assets/img/valunteer-05.png" alt="" />
            </div>
            <div class="content">
              <div class="author-meta">
                <span class="author-name">Pier Goodman</span>
            ...
            <div class="col-lg-3 col-md-6">
              <ul class="contact_info_list wow animate__animated animate__fadeInUp">
                ...
                <li class="single-info-item">
                  ...
                  <div class="details">
                    <a href="https://themeim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d5bcbbb3ba95acbaa0a7b8b4bcb9fbb6bab8">[email&#160;protected]</a>
                  </div>
                </li>
                <li class="single-info-item">
                  <div class="icon">
